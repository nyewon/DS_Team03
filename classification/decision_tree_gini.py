...
def run_decision_tree_gini(data_path="data/imdb_movies_processed.csv"):
    # 데이터 불러오기
    ...
    plt.title(f"Decision Tree(Gini impurity)")
    plt.tight_layout()
    plt.show()
    ...
    plt.title("Decision Tree Feature Importance(Gini impurity)")
    plt.tight_layout()
    plt.show()