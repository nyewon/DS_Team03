def run_decision_tree_entropy():
    """Train Decision Tree (Entropy) and visualize performance & importance."""
    import pandas as pd
    import numpy as np
    ...
    print(f"\n-Overall Average Performance (Entropy)")
    ...
    plt.tight_layout()
    plt.savefig("outputs/decision_tree_entropy_cm.png")
    plt.close()
    ...
    plt.title("Decision Tree (Entropy)")
    plt.tight_layout()
    plt.savefig("outputs/decision_tree_entropy_tree.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig("outputs/decision_tree_entropy_importance.png")
    plt.close()

    print("[✓] decision_tree_entropy.py done")
